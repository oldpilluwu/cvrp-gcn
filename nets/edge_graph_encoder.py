...
class EdgeGraphAttentionEncoder(nn.Module):
    def __init__(
            self,
            n_heads,
            embed_dim,
        ...
        super(EdgeGraphAttentionEncoder, self).__init__()

        # To map input to embedding space
        self.init_embed = nn.Linear(node_dim, embed_dim) if node_dim is not None else None
        self.gcn_layer = ResidualGatedGCNLayer(hidden_dim=embed_dim)
